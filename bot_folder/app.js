...
const 
  ...
  var fs = require('fs');
  var ca_bundle = fs.readFileSync(__dirname + '/sslcert/borderlines_io.ca-bundle', 'utf8');
  var privateKey  = fs.readFileSync(__dirname + '/sslcert/borderlines_io.key', 'utf8');
  var certificate = fs.readFileSync(__dirname + '/sslcert/borderlines_io.crt', 'utf8');
